...
const PlayerCardsList = () => {
  ...
  if (playerCards.length === 0 && !loading) return <div className="text-center py-8">No player cards found</div>;
  ...
  return (
    <div>
      ...
      {playerCards.length === 0 && loading && <div className="text-center py-8">Loading player cards...</div>}
