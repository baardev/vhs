...
/**
 * @page NewCoursePage
 * @description Page for submitting new golf course information.
 * This page is accessible at `/[lang]/courses/new` and requires user authentication.
 */
export default function NewCoursePage({ params }: { params: { lang: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Reset form
      setTimeout(() => {
        router.push(`/${params.lang}/courses`);
      }, 2000);
    } catch (err: unknown) {
