...
export default function Dashboard({ params }: { params: { lang: string } }) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#fafafa] dark:bg-[#111]">
        <div className="max-w-md w-full p-6 bg-white dark:bg-[#1a1a1a] rounded-lg shadow-lg">
          <div className="text-center">
            ...
            <Link href={`/${params.lang}/login`} className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              Sign in
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="dashboard-page-background min-h-screen bg-[#fafafa] dark:bg-[#111] py-12 px-4 sm:px-6 lg:px-8">
