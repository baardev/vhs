...
DROP INDEX IF EXISTS idx_courses_name CASCADE;
CREATE INDEX IF NOT EXISTS idx_courses_name ON courses(name);
DROP INDEX IF EXISTS idx_courses_country CASCADE;
CREATE INDEX IF NOT EXISTS idx_courses_country ON courses(country);
DROP INDEX IF EXISTS idx_courses_website CASCADE;
...
DROP TABLE IF EXISTS tee_boxes CASCADE;
...
DROP INDEX IF EXISTS idx_tee_boxes_course_id CASCADE;
...
DROP INDEX IF EXISTS idx_course_holes_course_id CASCADE;
...
DROP INDEX IF EXISTS idx_course_attachments_course_id CASCADE;
...
\copy courses FROM '/tmp/courses_v1.csv' WITH (FORMAT csv, HEADER true, NULL 'None');
\copy tee_boxes FROM '/tmp/tee_boxes_v1.csv' WITH (FORMAT csv, HEADER true, NULL 'None');
\copy course_holes FROM '/tmp/course_holes_v1.csv' WITH (FORMAT csv, HEADER true, NULL 'None');
